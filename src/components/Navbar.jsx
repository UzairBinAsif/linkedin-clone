...
import { FaBell, FaCaretDown, FaCircle, FaSearch } from 'react-icons/fa'
        ...
        <nav className='flex justify-center bg-white border-b border-[#E8E8E8]'>
            <div className='w-[75%] flex items-center justify-between'>
                ...
                <div className='h-[50px] flex justify-center items-center'>
                    ...
                    <button className='w-[80px] h-full flex flex-col justify-center cursor-pointer text-[#666666] hover:text-black items-center border-r border-[#E8E8E8] mr-3'><FaCircle className='w-6 h-6' />
